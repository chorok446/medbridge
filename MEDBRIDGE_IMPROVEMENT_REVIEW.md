...
> - 마지막 제품 코드 검증 커밋: `6910217151a7db897d263b98b560a62d931d76bc`
> - 마지막 테스트 검증 커밋: `6910217151a7db897d263b98b560a62d931d76bc`
...
- 실제 두 페이지의 저장 좌표를 읽기 전용으로 재계산했다. 한 표의 제목과 I–IV 행은
  연속으로 묶였고 원문·좌표·신뢰도 0.5를 보존했다. 인접 일반 절 제목 문제는 남는다.
  기존 사용자 문서·설정·대화는 그대로이며 설치본이나 활성 청크를 교체하지 않았다.
- 다음은 격리된 자료 사본에서 남은 절 경계와 전체 청크/동일 질문을 비교하는 일이다.
