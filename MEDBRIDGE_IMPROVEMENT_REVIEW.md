...
> - 마지막 제품 코드 검증 커밋: `dde86c6f930af95f21de4b16f6f7811937633d83`
> - 마지막 테스트 검증 커밋: `f7dfb5f14e890b6ed9abe47b821de5c7ed6f09dc`
...
- 다음 작업은 표 제목과 후속 행의 좌표/읽기 순서 연결을 확인하고 합성 fixture로
  구조화 후보의 완결성을 검증하는 것이다. 원문 선택을 최종 답변 완료로 간주하지 않는다.
