...
> **출시 판정: 보류 (HOLD)** — 2026-09-12 `6910217`은 표 캡션 경계 순서 보정이다.
> 새 회귀 **23개**, 전체 API **1,491개** 통과. 제품의 새 추출 순서가 변경됐다.
> 실제 좌표를 메모리에서 재계산해 한 표의 제목/네 행 연결을 확인했다.
> 기존 사용자 데이터와 설치본은 그대로이며 일반 절 경계·분류 완결성은 미해결이다.
