...
> **출시 판정: 보류 (HOLD)** — 2026-09-17 기존 후보의 점검 상태 누락을 현재 런타임에서 재현했다.
> 대상 해석 지침만 추가한 새 비교 후보는 무관 출처까지 선택하고 통신 오류로 중단돼 채택하지 않는다.
> 기존 후보 24회 완료·품질 실패 3회, 새 후보 3/24회·품질 실패 1회·실행 오류 1회다. 둘 다 종료 2다.
> 새 회귀 26개·관련 258개·전체 API **1,949 passed / 4 skipped**, Ruff·mypy 통과. 총 모델 시도 28회다.
> 직전 HEAD b42d65d의 CI `34921891931` 전체 success 확인. 새 평가 코드 커밋은 `be87c93`이다.
