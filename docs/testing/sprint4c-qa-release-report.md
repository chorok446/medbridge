...
> **출시 판정: 보류 (HOLD)** — 2026-09-09 중복 제거·인용 지침 후속 수정
> `ae32c07`의 강화된 qwen3:8b 전체 평가는 37/39 통과다. 평가 기준상 위해 노출
> 위반은 0건이지만 문단 번호 누락 2회로 안전 중요 케이스 게이트가 실패했다.
> 새 코드의 installer 검증과 Windows 36항목도 미완료이며 승인 파일은 생성하지 않는다.
