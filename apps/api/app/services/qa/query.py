...
def classification_requested(question: str) -> bool:
    """분류는 전역 OR 검색어 대신 주제 주변 문맥을 고르는 의도로 보존한다."""
    return "분류" in _question_terms(question)
